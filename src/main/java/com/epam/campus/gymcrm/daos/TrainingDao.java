...
public class TrainingDao implements Dao<Training>{
    ...
    public TrainingDao(List<Training> trainings) {
        trainings.add(new Training(1, 1, 1, "Agility 101", new TrainingType("Agility"), LocalDate.of(2025, Month.MARCH, 1), 1));
        trainings.add(new Training(2, 2, 2, "Basics of Self Defense", new TrainingType("Self Defense"), LocalDate.of(2025, Month.FEBRUARY, 28), 3));
    }
